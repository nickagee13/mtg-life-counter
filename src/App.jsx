...
try {
  ...
  console.warn('Supabase failed to load:', error.message);
  // Create a mock supabase object for when it fails to load
  supabase = {
    from: () => ({
  ...
  if (hasError) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: '0.875rem', marginBottom: '2rem', opacity: 0.8 }}>
          Error: {errorMessage}
        </div>
        <button
